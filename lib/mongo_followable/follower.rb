module MongoFollowable
  module Follower
   ...
   included do |base|
     if defined?(Mongoid)
       base.has_many :followees, :class_name => "MongoFollowable::Follow", :as => :following, :dependent => :destroy
     elsif defined?(MongoMapper)
       base.many :followees, :class_name => "MongoFollowable::Follow", :as => :following, :dependent => :destroy
     end
   end
